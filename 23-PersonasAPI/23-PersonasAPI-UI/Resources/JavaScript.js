...
function cargarListadoPersonasConDepartamento() {
    ...
    miLlamada.open("GET", "https://localhost:44315/api/Departamentos");
...
function crearTabla(listaDep) {
    ...
    var miLlamada = new XMLHttpRequest();
    miLlamada.open("GET", "https://localhost:44315/api/Personas");
    ...
    miLlamada.onreadystatechange = function () {
        ...
        if (miLlamada.readyState == 4 && miLlamada.status == 200) {
            ...
            for (i = 0; i < listadoPersonas.length; i++) {
                ...
                edit.setAttribute("src", "../Resources/Imagenes/edit.jpg");
                ...
                remove.setAttribute("src", "../Resources/Imagenes/delete.png");
...
function insertarPersona(pers) {
    ...
    llamadaInsertar.open('POST', "https://localhost:44315/api/Personas/", false);
...
function clickEliminar() {
    ...
    aceptar.onclick = function () {
        ...
        llamadaEliminar.open("DELETE", "https://localhost:44315/api/Personas/" + id);
...
function clickEditar() {
    ...
    btnConfirmar.onclick = function () {
        ...
        var miLlamada = new XMLHttpRequest();
        //miLlamada.open("PUT", "https://localhost:44315/api/Personas/" + per.idPersona, false); //Le hacia falta el false, dios sabra porque.
        miLlamada.open("PUT", "https://localhost:44315/api/Personas/" , false); //Le he quitado la id y sin problemas
...
function consultarPersona(id) {
    ...
    var persona;
    var miLlamada = new XMLHttpRequest();
    miLlamada.open("GET", "https://localhost:44315/api/Personas/" + id, false);
